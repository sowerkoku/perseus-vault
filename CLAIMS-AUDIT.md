...
- **44 MCP tools** — exactly 44 distinct `mimir_*` tool names registered in source (`src/*.rs`). README, badge, and the "44 MCP Tools" section all agree. ✓
...
- 2026-06-12 (v0.5.0): 23 tools. 2026-06 interim: 30 tools (#130). Now **44** (#271 added mimir_semantic_search).
