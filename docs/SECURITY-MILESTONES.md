...
| M2 | **Before tagging 1.0 / GA** | (a) A full independent security audit; (b) signed releases with SLSA provenance; (c) close the plaintext gap — extend encryption from entity bodies to the FTS index + metadata. | ⬜ Open |
